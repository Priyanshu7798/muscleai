                ...
                <TabsContent value='workout'>
                  <div className="space-y-4">
                    ...
                    <Accordion type='single' className='space-y-4'>
                      {currentPlan.workoutPlan.exercises.map((workDay,index)=>(
                        <AccordionItem
                          key={index}
                          value={workDay.day}
                        ...
                        >
                          <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-primary/10 font-mono">
                            <div className="flex justify-between w-full items-center">
                              <span className="text-primary">{workDay.day}</span>
                              <div className="text-xs text-muted-foreground">{workDay.routines.length}</div>
                            </div>
                          </AccordionTrigger>

                          <AccordionContent className="pb-4 px-4">
                            <div className="space-y-3 mt-2">
                              {workDay.routines.map((routine,index)=>(
                                <div
                                  key={index}
